        ...
        <h3>Palestra 1: Threat Hunting - A evolução do SOC (por Renato Fontana)</h3>
        ...
        <h3> Palestra3: IPv6: conceitos, desafios e vantagens para a Internet das coisas (por Tiago Sanchotene)</h3>
